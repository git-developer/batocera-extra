...
### Games
#### multi_bomberman
* A batocera service for https://github.com/alexis-puska/lr-multi-bomberman[lr-multi-bomberman],
  a Bomberman clone for up to 16 local players. Will be listed in group _Ports_
  after enabling the service and reloading the game list.
