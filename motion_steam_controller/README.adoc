= sc-controller
:url-sc-controller: https://github.com/C0rn3j/sc-controller
...
==== Examples
Additional profiles can be found in {url-sc-controller}/tree/main/profile_examples[profile_examples].
